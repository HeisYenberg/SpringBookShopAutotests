...
public final class DatabaseUtil {
    ...
    public static <T> T queryForObject(final RowMapper<T> rowMapper, final String sql, final Object... params) {
    ...
    public static <T> List<T> queryForList(final RowMapper<T> rowMapper, final String sql, final Object... params) {
        List<T> objects = new ArrayList<>();
        executeQuery(preparedStatement -> {
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                int rowNum = 0;
    ...
    public static int update(final String sql, final Object... params) {
        ...
        executeQuery(preparedStatement -> updated.set(preparedStatement.executeUpdate()),
                sql, params);
        return updated.get();
    }
    ...
    private static void executeQuery(final StatementHandler statementHandler,
                                     final String sql,
                                     final Object... params) {
